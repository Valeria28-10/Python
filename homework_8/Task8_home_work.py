# Задание 2. Напишите функцию, которая получает на вход директорию 
...
def dir_walker(aim_path: str, total_dct: dict = None) -> dict[str, dict[str]]:
    if total_dct is None:
        total_dct = {}
        basic_path = os.path.split(os.path.abspath(aim_path))                                           #('F:\PYTHON_COURSE'\Seminar_8')
...
def main():
    ...
    #tst_path = 'F:\PYTHON_COURSE'\Seminar_8'
